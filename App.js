...
export default class App extends React.Component {
  ...
  getIdeas() {
    ...
    let airtableUrl = "https://api.airtable.com/v0/app20vh4mBTG10F4j/fruit";

    // Needed for Airtable authorization, replace with your own API key
    let requestOptions = {
      headers: new Headers({
        'Authorization': 'Bearer keydU2fPZb5vhlEdu'
      })
    };
  ...
  upvoteIdea(data, secId, rowId, rowMap) {
    ...
    let requestOptions = {
      method: 'PATCH',
      headers: new Headers({
        'Authorization': 'Bearer keydU2fPZb5vhlEdu', // replace with your own API key
